...
mmap_sweep_path = str(sys.argv[3])
mmap_target_path = str(sys.argv[4])
...
model,score=train_model(model,mmap_neutral,mmap_sweep,mmap_target,val_split=val_split,batch_size=batch_size,loss_weights=initial_loss_weights,path=model_name) #GRL_HS_DuringBottleneck_trained
